  ...
  return (
    <div className="max-w-6xl mx-auto px-4 pt-6 pb-4">
      ...
      <div className="mt-6 mb-4">
        <ChipGroup label="Map layer">
          <ToggleChip active={mode === 'air'} onClick={() => setMode('air')} accent="sky">Air quality</ToggleChip>
          <ToggleChip active={mode === 'fires'} onClick={() => setMode('fires')} accent="amber">Fire activity</ToggleChip>
        </ChipGroup>
      </div>
